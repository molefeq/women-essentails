(function () {
    ...
    searchSalonsController.$inject = ['$scope', '$rootScope', '$state', '$stateParams', 'notificationFactory', 'productsFactory'];

    function searchSalonsController($scope, $rootScope, $state, $stateParams, notificationFactory, productsFactory) {
        var viewModel = $scope;
