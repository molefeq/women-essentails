(function () {
    ...
    searchPromotionProductsController.$inject = ['$scope', '$rootScope', '$state', '$stateParams', 'notificationFactory', 'promotionProductApiFactory'];

    function searchPromotionProductsController($scope, $rootScope, $state, $stateParams, notificationFactory, promotionProductApiFactory) {
        var viewModel = $scope;
