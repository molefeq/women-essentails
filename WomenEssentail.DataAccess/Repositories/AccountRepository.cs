...
namespace WomenEssentail.DataAccess.Repositories
{
    public class AccountRepository :  DataAccessEntitySet<AccountDto> 
	{
		...
		private SqlQueryParameter[] GetSaveParameters(AccountDto accountDto)
		{
			...
			{
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "Id", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.Integer, ParameterValue = accountDto.Id });
			}
			...
			if (accountDto.CrudStatus == CrudStatus.CREATE || accountDto.CrudStatus == CrudStatus.UPDATE)
			{
				...
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "AccountUserId", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.Integer, ParameterValue = accountDto.AccountUserId });
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "IsFirstTimeLoggedInd", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.Boolean, ParameterValue = accountDto.IsFirstTimeLoggedInd });
				...
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "StatusId", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.Integer, ParameterValue = accountDto.StatusId });
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "LastLoginDate", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.DateTime, ParameterValue = accountDto.LastLoginDate });
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "CreateDate", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.DateTime, ParameterValue = accountDto.CreateDate });
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "CreateUserId", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.Integer, ParameterValue = accountDto.CreateUserId });
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "EditDate", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.DateTime, ParameterValue = accountDto.EditDate });
				...
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "ExternalAuthenticationTypeId", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.Integer, ParameterValue = accountDto.ExternalAuthenticationTypeId });
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "ExternalAuthenticationKey", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.String, ParameterSize = 500, ParameterValue = accountDto.ExternalAuthenticationKey });
				sqlQueryParameters.Add(new SqlQueryParameter { ParameterName = "ForgotPasswordKey", ParameterDirection = DbParameterDirection.Input, ParamentType = CodeParameterType.Guid, ParameterValue = accountDto.ForgotPasswordKey });
			}
